...
(function() {
    ...
    function D(E) {
        ...
        function Pn(n, t) {
            for (var r = n.length; r--;) if (pe(n[r][0], t)) return r;
            return -1
        }
        function Tn(n, t, r) {
            var e = Pn(n, t);
        ...
        function zt(n, t, r) {
            ...
            for (r && (o = a(n, function(n) {
                return r(n)
            })); ++e < u;) for (var i = 0, f = t[e], f = r ? r(f) : f; - 1 < (i = d(o, f, i));) o !== n && Iu.call(o, i, 1), Iu.call(n, i, 1);
            return n
        }
        function Mt(n, t) {
        ...
        yn.forIn = function(n, t) {
            ...
            for (var t in n) if (lu.call(n, t)) return false;
            return true
